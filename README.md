...
Modern customizable expense tracker with:
- Dashboard KPIs, charts, and searchable transactions
...
- API key is also stored in local browser storage if you choose to add one.
